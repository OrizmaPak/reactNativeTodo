  ...
  return (
    <>
      <View style={styles.modal}>
        <Text style={{ width: '90%', marginLeft: 'auto', marginRight: 'auto', fontFamily: 'anton', textAlign: 'center', color: 'white', fontSize: 20, display: action == 'edit' ? 'flex' : 'none' }}>
          Editing Task: {task}
        </Text>
        <Text style={{ width: '90%', marginLeft: 'auto', marginRight: 'auto', fontFamily: 'anton', textAlign: 'center', color: '#36000CFF', fontSize: 19, display: action == 'delete' ? 'flex' : 'none' }}>
          Are you sure you want to delete Task:
        </Text>
        <Text style={{ width: '90%', marginLeft: 'auto', marginRight: 'auto', fontFamily: 'anton', textAlign: 'center', color: '#FFEBF2FF', fontSize: 22, display: action == 'delete' ? 'flex' : 'none' }}>
          {task}?
        </Text>
        ...
        >
          <CheckBox checked={inputcheck} onPress={() => setInputcheck(!inputcheck)} />
